...
- **HF77**: パラメータ・重み・データ値は業務担当者の明示数値指示＋1 件ずつ。重みの単一の真実は `MirrorKeys.WeightOf`（Android の
  `MirrorKeys.weights` と同値、3.556.0 まで反映済み: groupViol 11000 > covU 10000 > c3n 9000 = c3w 9000 > pref 8000 > low 120 >
  c3mn 90 > c1 50 > high 25 > c3 15 > c41s 10 = c42s 10 = covO 10 > c41 9 = c42 9 > c3m 6 > c2 4 = apt 4 > fair 2 = weekly 2）。
