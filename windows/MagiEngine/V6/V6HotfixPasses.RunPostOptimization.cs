...
public static partial class V6HotfixPasses
{
        ...
        long deadlineMs = long.MaxValue)
    {
        ...
        var totalRange = 0; var totalC3run = 0; var totalC3pat = 0; var totalBlockSwap = 0; var totalApt = 0; var totalFair = 0;
        ...
        //   採用0かつ対象>0なら「頭打ち(改善手なし=正常)」、対象0なら「対象なし」と明示。
        {
            ...
            var adopted = totalCyc + totalC1 + totalC3 + totalC3r + totalC3mn + totalC3n + totalRange +
                totalC3run + totalC3pat + totalBlockSwap + totalApt + totalFair;
            ...
            logs.Add(new MirrorLog(tag: "SoftPolishVerify", message:
                ...
                $" range玉突き:{totalRange} c3run玉突き:{totalC3run} c3pattern玉突き:{totalC3pat} ブロック交換:{totalBlockSwap}" +
