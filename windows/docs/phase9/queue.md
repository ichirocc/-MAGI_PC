...
| 21 | 設定 | 色ピッカー 36色（6×6・淡いパステル・選択✓, 3.460.0） | `ShiftColorEditor.kt` `ColorPickerDialog` | `SettingsView` | 済 | 済 | 未 | `ShiftColorPalette`（ViewModels、テスト 2 件）＋`SettingsView.BuildColorPickerFlyout` を 6×6 タイル＋✓ に差し替え。16進入力は残す |
