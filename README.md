...
**最終更新**：2026-08-23（3.432.0＝色ピッカーの25色を淡いパステル調へ差し替え＋選択チェック印を太字化
（ユーザー指示「淡い中間色 25色＋ 濃色太字テキスト」＋実機スクショ）。差し替え前に全25色の輝度を算出し
pickFg()のしきい値(140)に対し一貫して濃色文字が選ばれることを確認済み。表示のみ・エンジン/採点は不変。
design_lint exit=0。
